...
\item Definir \emph{buscadors} i \emph{directoris} i diferenciar-los
  ...
  que ens entrega pàgines amb llistes d'URI i una breu descripció
...
Anomenem \emph{Internet} un conjunt d'ordinadors, distribuïts arreu
...
Un URI té generalment tres parts, encara que s'hi donen algunes
...
Una adreça electrònica pot també identificar una llista d'usuaris
...
\begin{figure}
\centering
\includegraphics[scale=0.35]{connex-internet}
...
En la majoria dels casos, el número IP públic que el nostre proveïdor
