...
Como ya hemos visto en el apartado~\ref{ss:memoria}, los \emph{bits} se agrupan en grupos de ocho (\emph{bytes} u \emph{octetos}): \begin{center} \texttt{01000001 01001101 01001001\ldots} \end{center} 
