\documentclass[11pt,a4paper]{book} \usepackage[spanish]{babel} \usepackage[utf8]{inputenc} 
...
\usepackage{natbib} \usepackage[framemethod=TikZ]{mdframed} \bibpunct{(}{)}{;}{a}{}{,} 
...
\bibliographystyle{apalikecat} \bibliography{llibrett} 
