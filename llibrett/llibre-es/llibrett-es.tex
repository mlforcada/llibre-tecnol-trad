...
\usepackage{url} \usepackage{fancyhdr} \usepackage{ifthen} \usepackage{alltt} \usepackage{covington} \usepackage[bf,small]{caption} \usepackage{xcolor} 
\usepackage{palatino} \usepackage{todonotes} \usepackage{colortbl} 
...
\usepackage{marvosym} \usepackage{wasysym} \usepackage{parsetree} \usepackage{graphicx} 

\usepackage{natbib}

\usepackage[framemethod=TikZ]{mdframed} \bibpunct{(}{)}{;}{a}{}{,} 
\usepackage{subfigure} 

\newcommand{\comprof}[1]{ \begin{quote} \begin{sf} #1 \end{sf} \end{quote} } 

%\renewcommand{\comprof}[1]{}
\newcommand{\pair}[2]{({#1},~{#2})} \pagestyle{headings} 

%% canviar a alguna classe de fancyhdr
...
% Per saber més
\definecolor{psm}{rgb}{0.98,0.98,0.98} \mdfsetup{skipabove=\topskip,skipbelow=\topskip} 

\global\mdfdefinestyle{exampledefault}{ backgroundcolor=psm, outerlinewidth=0pt,innerlinewidth=0pt, roundcorner=5pt, } 

%
\newenvironment{persabermes}[1]{ \begin{mdframed}[style=exampledefault] \begin{footnotesize} \subsection*{Para saber más sobre #1} } { 

%%
\mbox{} \end{footnotesize} \end{mdframed} } 

\newcommand{\ter}[1]{\mbox{\bf #1}\;} \newcommand{\nter}[1]{\mbox{\em #1}\;} \newcommand{\der}{&\longrightarrow &} 

\newenvironment{exemple}{\begin{example}\sl}{\end{example}} 

\newcommand{\com}[1]{\begin{quote}{\small\sf #1}\end{quote}} \renewcommand{\com}[1]{} 
...
\date{Edición 0.9.3, febrero de 2023\\Primera edición (0.9), febrero de 2016} \maketitle

\newpage

\noindent Copyright (c) 2004--2023 Mikel L. Forcada, Felipe Sánchez Martínez \& Juan Antonio Pérez Ortiz \\[0.3cm] 
...
\com{Lista (incompleta) de coses a fer: \begin{itemize} \item Integrar problemes resolts d'examens de prova i exercicis dels tests. \item Integrar anotacions de la llibreta de classe de 2002--2003 (algunes ja integrades). \item Aprofitar material de transparències de màsters, etc. (alguns ja ficats). \item Citar els capítols corresponents del nou llibre de Somers. \item Revisar el llibre repassant la llista d'objectius del curs. \end{itemize} } 
