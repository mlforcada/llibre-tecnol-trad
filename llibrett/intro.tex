...
de traducció (capítol~\ref{se:memtrad}).\todo{Redacció original: i la
  tercera, un recull d'aspectes més concretament referits a la
  traducció espanyol--català (capítols~\ref{se:PdTACC} i
  \ref{se:ETACC}), els quals poden servir com a il·lustració de
  l'estudiat en un cas concret. Els continguts d'aquesta tercera part
  són, per tant, complementaris.}
...
A més, és segur que hi ha errades que s'han de corregir. El text està
