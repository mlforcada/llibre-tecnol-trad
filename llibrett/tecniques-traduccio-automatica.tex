...
\ref{fg:alinora}. Primerament, s'han d'obtenir els \emph{alineaments a
  nivell paraula} (vegeu un exemple en la figura \ref{fg:alinpar}) per
a després estimar el model de traducció a partir d'aquests
alineaments. 
...
coneixement sobre les llengües del textos a alinear. La figura
\ref{fg:pasosalin} mostra pas per pas com s'obté alineament a nivell
de paraula mitjançant un procés iteratiu.
