...
si són basats en regles o en corpus, adopten la que podríem anomenar
...
traducció com una aplicació del \emph{principi de composicionalitat
...
D'altra banda, els sistemes de traducció automàtica indirecta per
...
global que es base en regles simples i ben formulades per a algunes
...
persona del singular i \emph{viu}, adjectiu, masculí, plural, on els lemes són,
...
a n g o ixa - - r<verb><presind><1p><pl>
                ...
                r<verb><imp><1p><pl> 
\end{verbatim}
En aquest últim cas, el mot té tres anàlisis morfològiques diferents.  Per
...
\item \label{pg:magradanadar} Però encara pot haver-hi més maneres
  ...
  \item la neerlandesa \emph{ik zwem graag} o l'alemanya \emph{ich
...
\item La multinacional WorldTrans ha decidit ampliar el seu sistema de
  traducció automàtica multilingüe basat en regles LetTrans (que tradueix
...
\item \emph{Interlingua}, a més de ser el nom de la representació
  ...
  llengua artificial d'arrel fonamentalment llatina, amb una flexió
...
\item (*) \label{ex:postres} Els sistemes de traducció automàtica
  ...
  correctament: esp. {\em una señal muy clara\/} $\rightarrow$
  cat. *{\em una senyal molt clara} (correcte: {\em un senyal molt
    clar\/}); esp. {\em me gusta la leche fría} $\rightarrow$
...
\item Tipus de canvis (per exemple, català$\to$espanyol$\to$català):
  ...
  \item Canvis de concordança: \emph{La dona cosia el coixí
      cansada}$\to$\emph{La mujer cosía la almohada
...
\item (només a tall d'exemple) Si la llengua origen és el català i la
  ...
  \item problemes de concordança: \emph{aquella gent estava feliç}
    $\to$ \emph{*that people *was happy} en comptes de \emph{those
      people were happy}.
  \item ambigüitat estructural mal resolta: \emph{Dóna'm la clau
