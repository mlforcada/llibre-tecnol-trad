...
\section[La traducció automàtica real entre\ldots]{La traducció automàtica real entre el principi de
  composicionalitat semàntica i la traducció mot per mot}\todo{Aquest apartat és una mena d'epíleg o represa i potser està bé ací almenys en aquesta edició}
...
\todo{Millorar aquest apartat: aprofitar les transparències de Felipe,
  el que Mikel va fer a Castelló, col·locant material avançat en
...
\todo{Repassar-los; afegir-ne més; seleccionar-los si hi ha
  repeticions; marcar els difícils i dir-ho; separar els de respostes
  alternatives dels de respostes obertes.}
