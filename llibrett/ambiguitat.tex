...
\begin{enumerate}
\item Ambigüitat entre categories lèxiques diferents. Per exemple, el
  mot \emph{moc} té dues formes lèxiques possibles, cadascuna amb una
  categoria lèxica diferent: \emph{moc}, substantiu, masculí,
  singular; \emph{moure}, verb, 1a.\ persona del singular, present
  d'indicatiu.
\item Ambigüitat dins de la mateixa categoria lèxica. Per exemple, el
  mot \emph{canta} té dues formes lèxiques amb el mateix lema, la
  mateixa categoria lèxica, però distinta informació de flexió:
  \emph{cantar} verm 3a.\ personal del singular, present d'indicatiu;
  \emph{cantar}, verb, 2a.\ personal del singular, imperatiu.
\item Ambigüitat dins de la mateixa categoria lèxica amb canvi de
  lema. Per exemple, el mot \emph{poden} té, entre d'altres, dues
  formes lèxiques amb la mateixa categoria lèxica, la mateixa
...
\item L'oració conté un homògraf que té dues o més interpretacions
  ...
  l'estructura de l'oració. Hi ha tres situacions possibles
  \begin{itemize}
...
\subsubsection{Resolució de la polisèmia}
 ...
 \todo{Aquesta secció necessita millorar molt!! Crec que Juan Antonio ja té
   material per a millorar-la. Cal donar més èmfasi al cas particular
   de l'ambigüitat de transferència.} 
