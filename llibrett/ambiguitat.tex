\chapter[Per què és difícil la TA? Ambigüitat.]{Per què és difícil la traducció automàtica? Ambigüitat}
\label{se:ambig}
...
obté la puntuació més alta \citep{lappin94p}.
...
usem estratègies fonamentalment sintàctiques, elegint entre les possibles
...
---en anglés \emph{late closure}---; per exemple, aquesta regla afavoreix
...
\todo{A la vista del concepte, és ``clausura tardana'' una bona
