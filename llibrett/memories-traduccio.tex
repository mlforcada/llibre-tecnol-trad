...
\begin{itemize}
\item Que es dóne una concordança exacta, com en el cas dels segments $e'_1$ i
  $e'_5$ i per tant, només calga comprovar que la proposta de la
  memòria es pot usar com la seua traducció.
\item Que es dóne una concordança parcial, com en el cas dels segments
...
$$
\begin{array}{rcl}
\mbox{\small\textsf{text esquerre}} \to
\mbox{\small\framebox{\textsf{segmentació}}} \to &
\mbox{\small\framebox{\parbox{1.9cm}{\textsf{concordança i selecció de propostes}}}} & \to \mbox{\small\framebox{\textsf{postedició}}} \to \mbox{\parbox{1.4cm}{\textsf{text dret
    traduït i segmentat}}} \\
& \uparrow \downarrow \mbox{\small\textsf{UTs}}& \\[0.5cm]
& \mbox{\small\framebox{\parbox{1.9cm}{\textsf{Memòria de traducció}}}} & \\
\end{array}
$$
