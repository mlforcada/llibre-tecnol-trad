...
finestres, etc. (Windows, GNU/Linux, MacOS, Android); antigament, els sistemes
operatius eren de {\em línia d'ordres}, és a dir, basats en text (Unix
primigeni, VAX/VMS, MS-DOS). Els sistemes poden ser tamb\'{e}
\emph{monousuari} (MS-DOS, Windows 3.11) o \emph{multiusuari} (Unix,
VAX/VMS), si poden o no donar acc\'{e}s i suport a m\'{e}s d'un usuari
alhora, o \emph{monotasca} (l'antic MS-DOS) i \emph{multitasca} (quasi tots
els altres); els primers no poden executar m\'{e}s d'un programa alhora, els segons sí. La major part dels sistemes operatius actuals estan a més preparats per a interaccionar amb altres dispositius través de diferents tipus de xarxes.\footnote{L'organització dels ordinadors en una
