...
\item[megahertz:] Un megahertz (MHz) \'{e}s un milió de hertzs (Hz),
  \'{e}s a dir, un milió de cicles per segon. La velocitat de les
  unitats centrals dels ordinadors es mesura en MHz i més recentment
  en GHz, \'{e}s a dir, en milions o milers de milions de cicles
  ...
  m\'{e}s d'un. Els models actuals poden executar, en determinades
  ...
  més d'una.  Una velocitat típica en l'actualitat \'{e}s 3~GHz, és a
...
\item[mòdem:] abreviatura de modulador-desmodulador. En el cas del
  ...
  b/s (m\'{e}s recentment, 57.600 b/s; les línies telefòniques actuals
