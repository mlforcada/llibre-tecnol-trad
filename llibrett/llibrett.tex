...
la possibilitat d'una estació de treball de traducció basada en elles: GNU/Linux
...
\item[adaptador de vídeo] (tamb\'{e} anomenada targeta gràfica o
  ...
  \emph{resolució}, \'{e}s a dir, el nombre de punts, elements
...
\item[GNU/Linux:] un sistema operatiu multitasca i multiusuari
  ...
  miniordinadors, desenvolupat de manera col·laborativa per milers de
  voluntaris independent i empreses arreu del món i que és
  \emph{programari lliure} (vegeu l'entrada en aquest glossari): es
  pot copiar lliurement si es compleixen certes condicions. Es pot
  instal$\cdot$lar GNU/Linux (que es presenta en moltes
  \emph{distribucions} diferents) en un PC amb processador de la
  família x86 (vegeu \emph{Pentium}) o superior i en molts altres
  tipus d'ordinador.
...
\item[megahertz:] Un megahertz (MHz) \'{e}s un milió de hertzs (Hz), \'{e}s a
  ...
  ordinadors es mesura en MHz i més recentment en GHz, \'{e}s a dir, en milions o milers de
...
\item[mòdem:] abreviatura de modulador-desmodulador. En el cas del
  ...
  que tamb\'{e} pot ser extern) que permetia usar la línia telefònica
...
\item[Programari lliure:] (\emph{free software}, també anomenat
  ...
  sèrie de llibertats a qui rep el programari: la llibertat d'usar-lo per
  a qualsevol propòsit sense restricció, la llibertat d'examinar-lo
  per veure com funciona i modificar-lo per adaptar-lo a un nou ús, i
  la llibertat de distribuir còpies ---originals o modificades---
  lliurement a qui desitgem. Per a poder modificar el programari, hem
  de tenir accés, a més de a la versió executable en l'ordinador, a
  l'anomenat \emph{codi font}, és a dir, a la versió del programari
  que escriuen i modifiquen les persones que programen (d'ací el nom
  \emph{de codi font obert}) i que després es tradueix automàticament
  a la versió executable. Exemples de programari lliure són: el
  sistema operatiu GNU/Linux, el navegador Firefox, o el processador
  de textos LibreOffice. No s'ha de confondre \emph{programari lliure}
  amb \emph{programari gratuït} (o \emph{freeware}). Hi ha programari
  ...
  telefonia per Internet \emph{Skype}: per exemple, no tenim accés al
  seu codi font).
...
\item[targeta de xarxa:] En els ordinadors més antics, per a connectar
  ...
  xarxa. Hi ha diversos estàndards de connexió en xarxa; els m\'{e}s
