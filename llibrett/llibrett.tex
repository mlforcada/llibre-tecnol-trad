...
\begin{persabermes}{instruccions de programa}
...
\begin{persabermes}{sobre algorismes}

%\section{Sobre algorismes}
\label{ss:algorismes}

El nom \emph{algorisme} ve del nom d'un
...
físicament als Estats Units d'Amèrica, però ara això ja no \'{e}s
...
{\tt .za}) s'usen indicatius similars ({\tt .co}(mercial), {\tt
  ...
  www.shef.ac.uk} \'{e}s la Universitat de Sheffield).
