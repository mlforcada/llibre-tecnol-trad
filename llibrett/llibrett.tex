...
\item Quina d'aquestes afirmacions es certa?
        ...
        \item En qualsevol disc (disquet, dur, CD-ROM) sempre hi ha un directori especial que
          es diu arrel.
        \item Un disc no pot contenir m\'{e}s de dos nivells de jerarquia
              de carpetes.
...
\item Quin dels tres mitjans d'emmagatzemament següents no \'{e}s òptic:
        \begin{enumerate}
        \item Un CD-ROM
        \item Un DVD
        \item Un disc fix.
...
\item Nom\'{e}s si la impressora està connectada a Internet.
